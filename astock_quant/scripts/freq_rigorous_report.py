...
<ul style="margin:6px 0 0 20px;padding:0">
<li><b>freq=60 的优势基本是日历运气。</b>单点是 TEST 39.71% vs 20.71%（+19pp）；多相位抹掉日历运气后只剩 <b>+4.35pp</b>（vs 20；CI −7.59~+12.89，p=0.71）；再放到 2016-2026 全段（10.7 年）更是塌到 <b>+0.22pp</b>（p=0.93）。频率效应≈0。</li>
<li><b>反而是 10→20 的收益改善被做实了。</b>表中 Δ 是「该频率 − freq=20」，所以 freq=10 的 Δ−11.87pp = <b>20 日比 10 日高 11.87pp</b>（p=0.016）；全段 Δ−4.95pp = 20 日高 4.95pp（p=0.004）——<b>两段都显著</b>。这是全部研究里唯一在完全独立的 OOS 段上站得住的收益差异，不只是省手续费。</li>
...
<li><b>反而 10→20 的收益改善被做实了。</b>多相位平均下，<b>20 日比 10 日高 11.87pp</b>（TEST 段，<b>p=0.016</b>）、<b>高 4.95pp</b>（全段 10.7 年，<b>p=0.004</b>），两段都显著。
