  ...
  return (
    <div className='rounded-xl bg-white p-4 shadow-sm dark:bg-[#111520]'>
      <div className='flex items-center justify-between gap-3'>
        <span className='text-xs font-medium text-gray-500 dark:text-gray-400'>公司备注</span>
      ...
      {dataLoading ? (
        ...
        <p className='mt-3 text-[11px] leading-5 text-gray-500 dark:text-gray-400 whitespace-pre-wrap'>
          {entryNote}
        </p>
      )}
    </div>
