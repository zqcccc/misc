...
export async function GET(request: Request) {
  ...
  const res = await fetch(
    `https://dict.youdao.com/suggest?num=5&ver=3.0&doctype=json&cache=false&le=en&q=${word}`,
    { cache: 'force-cache' }
  ).then((res) => res.json())
