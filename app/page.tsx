    ...
    <main className='home-page'>
      ...
      <section className='home-section home-about' aria-labelledby='home-about-title'>
        ...
        <div>
          ...
          <p>
            我希望读者看一篇投资研究时能查到数据口径，看一篇工程笔记时能跳到原始仓库，看一个工具时能判断结果是不是从我自己电脑上算出来的。个人网站可以把这些证据与原文一直保留，不被算法推荐与平台编辑覆盖。
          </p>
          <p>
            同时它也是我对自己的提醒：每篇文章都会标注发布与更新日期；金融类内容都会披露数据来源与不能证明的部分；工具页面会说明数据是否上传服务器、能否复现。不写“永远正确”的话，也不偷偷把错误判断抹掉。
          </p>
          <p>
