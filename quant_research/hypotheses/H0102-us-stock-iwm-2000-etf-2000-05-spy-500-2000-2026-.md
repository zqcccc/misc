...
plain:
report:
claimed_at: 2026-09-07T09:13:37Z
updated_at: 2026-09-07T09:14:01Z
sources: https://en.wikipedia.org/wiki/Size_effect 
---

# H0102 · 在 us_stock 上，小盘溢价：持有 IWM（罗素2000 ETF，2000-05 起可交易）相对 SPY（静态对照=恒定持有标普500）的溢价：2000-2026 相对静态日频资金曲线净增量>0 且 NW t>=2，两个子段同号，成本(单边3bp)后仍成立。预注册预测 FAIL（小盘效应 1983 后已死：Fama-French 后消失、2000-2026 全窗口在死亡期后，2013-2020 小盘持续跑输大盘）。
...
## 探索日志
- `2026-09-07T09:14:01Z` 未署名：放弃占坑 —— 重复占坑（与H0101同假设，claim命令报错但实际执行了两次）
